...
echo "训练结果模型复制到本地"
scp -P 2222  admin@8.140.49.13:/home/admin/python_projects/ultralytics/runs/detect/$(date +"%Y-%m-%d.%H")/weights/best.onnx ~/python_projects/ultralytics/mcd/weights/huiji.onnx
